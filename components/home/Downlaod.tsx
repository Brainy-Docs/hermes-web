    ...
    return (
        <section className="pt-20 pb-28 bg-white overflow-hidden">
            <div className="container px-4 mx-auto">
                <h2 className="text-6xl md:text-7xl text-center font-bold font-heading font-heading tracking-px-n leading-tight md:max-w-lg mx-auto pb-4">Commandez vos plats en seulement 3 étapes</h2>
            </div>
